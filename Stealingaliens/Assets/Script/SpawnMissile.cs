...
public class SpawnMissile : MonoBehaviour
{
    ...
    void Spawn(){
        ...
        Instantiate(missilePrefab, transform.position + new Vector3(randomX, randomY, 0), transform.rotation); // Instantiate the cow prefab at the calculated position with the same rotation as the spawner
    }
